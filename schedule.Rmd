...
```{r, echo = FALSE, results='asis'}
make_week_box("week9", TRUE, "Week 9: Mar 18 -- 22",
"
...
#### Wed, Mar 20
 * **In Class**, we will work on:
    * Large-sample normal approximation to the sampling distribution of the MLE.
    * Confidence intervals based on large-sample normal approximations?
