...
**Definition:** A Markov chain is a sequence of random variables $X_1, X_2, \ldots$ with the property that for any set $A$,
...
**Remarkable fact 2:** For the Metropolis algorithm above, the stationary distribution is the posterior distribution for $\Theta$.
