...
ggplot() +
  geom_line(data = plot_df, mapping = aes(x = x, y = y, color = Curve), size = 1) +
  geom_vline(xintercept = mean(x_obs), color = "orange", size = 1) +
  geom_vline(xintercept = lambda_vals[1], size = 1, color = "lightgrey") +
...
ggplot() +
  ...
  geom_vline(xintercept = mean(x_obs), color = "orange", size = 1) +
  geom_vline(xintercept = lambda_vals[1], size = 1, color = "lightgrey") +
  geom_vline(xintercept = lambda_vals[2], size = 1, color = "lightgrey") +
...
ggplot() +
  ...
  geom_vline(xintercept = lambda_vals[1], size = 1, color = "lightgrey") +
  geom_vline(xintercept = lambda_vals[2], size = 1, color = "lightgrey") +
  geom_vline(xintercept = lambda_vals[3], size = 1, color = "lightgrey") +
