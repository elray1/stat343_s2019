---
title: "Bias, Variance, and MSE of Maximum Likelihood and Bayesian Estimators of the Mean of a Univariate Normal Distribution"
output:
  pdf_document:
    keep_tex: yes
---
...
## Case 1: Bayesian Estimator has larger bias away from the prior mean, lower variance everywhere, lower MSE near the prior mean
...
## Case 2: Location where Bayesian Estimator has lower MSE depends on the prior mean.
...
## Case 3: Range of values where Bayesian Estimator has lower MSE depends on the relative sizes of $\xi$ and $\xi_{prior}$.
