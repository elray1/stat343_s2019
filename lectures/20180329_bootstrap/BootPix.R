...
setwd("~/teaching/2018-spring-stat343/stat343_s2018/lectures/20180329_bootstrap/")
...
pdf("idealWorld3.pdf", height = figureHeight)
...
axis(1, at = Ameans[first], expression(bar(x)), col = "red")
